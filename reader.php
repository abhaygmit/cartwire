...
//exit;
    ...
    */
        ...
        if($res === false) {
            ...
            // bad file
                die("<div style='padding-top:80px; padding-left:100px;color:#ff0000;font-size:14px;'><b>Please upload Microsoft Excel 97-Excel 2003 & 5.0/95 Workbook (*.xls). <a href='javascript:window.history.go(-1)'>Click here</a> to go back</b></div>");
            }
